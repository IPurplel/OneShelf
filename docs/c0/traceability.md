...
| M26.15 | Continue Reading restores exact same-source progress; Long Strip approximate | C2 | be/reader, fe/home | Home, Work Details | progress | Home offers Continue Reading and routes to the right unit (`test_url_and_home.py`). **Missing:** the reader opens at page 1 rather than the stored position | IN_PROGRESS |
